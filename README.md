...
[![Stars](https://img.shields.io/github/stars/yonathan-star/puppal_app1?style=flat&color=FFD166)](https://github.com/yonathan-star/puppal_app1/stargazers)
...
```bash
git clone https://github.com/yonathan-star/puppal_app1.git
cd puppal_app1
flutter pub get
flutter run
```
...
```dart
import 'package:puppal_app1/pages/feeding_calculator_page.dart';
